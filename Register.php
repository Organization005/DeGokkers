...
class SimpleDBClass
{
    ...
    public function __construct( $db_conn = array('host' => 'localhost', 'user' => 'root','pass' => '','database' => 'test', ) )
    {
        ...
        $user = isset($db_conn['user']) ? $db_conn['user'] : 'mark2' ;
        $pass = isset($db_conn['pass']) ? $db_conn['pass'] : 'admin123' ;
        $database = isset($db_conn['loginsystem']) ? $db_conn['loginsystem'] : die('no database set') ;
        // Create connection
